...
VPN_TYPES = {
    "reg": glob.glob("../../classes_csvs/**/reg/*.npy"),
    "vpn": glob.glob("../../classes_csvs/**/vpn/*.npy"),
    "tor": glob.glob("../../classes_csvs/**/tor/*.npy")
}
...
def create_class_vs_all_specific_vpn_type_dataset(class_name, vpn_type="reg", validation=False, ratio=1.2):
    # print(VPN_TYPES[vpn_type])
    # print("print here")
    # print(class_name)
    # print([fn for fn in VPN_TYPES[vpn_type] if class_name in fn and "overlap" not in fn])
    # if [fn for fn in VPN_TYPES[vpn_type] if class_name in fn and "overlap" not in fn]:
    #     return 1
    # print(fn for fn in VPN_TYPES[vpn_type])
    # print(fn for fn in VPN_TYPES[vpn_type] if class_name in fn)
    # print([fn for fn in VPN_TYPES[vpn_type] if class_name in fn and "overlap" not in fn])
    # if [fn for fn in VPN_TYPES[vpn_type] if class_name in fn and "overlap" not in fn]:
