...
if __name__ == '__main__':
    ...
    file_list = [(i,i) for i in glob('D:\Infomedia_data_backups\Raw pcaps\\filtered_raw_dataset_temu2016_first_10_min\**\*.csv') if '.pcap' in i]#get_csvs_list(FLAGS.input, FILTER_LIST)
