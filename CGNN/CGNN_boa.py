...
def main():
    ...
    files_names = glob.glob("./filtered_raw_dataset_temu2016_first_10_min/*/*.npy")
    labels = [int(i.split("_")[-1][:5]) for i in files_names]
    ...
    result = tf.math.confusion_matrix(labels=_idx, predictions=idx,
                                      num_classes=35)  # use one hot to convert to 1D to do confMatrix
    print(result)
    # =========================================================================================
